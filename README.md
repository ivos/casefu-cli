...
2. Install the CaseFu CLI module:
   	...
   	npm i casefu-cli casefu-converter --save-dev

3. Add npm scripts. Add the following two rows into the `scripts` section of the `package.json` file:
...
1. Open a terminal in the project directory and execute
...
[**available here
**](https://htmlpreview.github.io/?https://github.com/ivos/functional-specification-sample/blob/develop/build/index.html#__home).
